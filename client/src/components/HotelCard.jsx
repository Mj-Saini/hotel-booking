  ...
  return (
    ...
    <>
      <Link to={`/rooms/${room.id}`}
        ...
        className='relative w-full  rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05]' key={room._id}>
        <img className='h-[250px] w-full' src={room?.image1_url} alt={room?.name} />
